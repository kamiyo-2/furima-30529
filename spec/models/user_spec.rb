...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録がうまくいくとき' do
      it "nicknameとemail、passwordとpassword_confirmation、nickname、 first_name、 last_name、first_name_kana、 last_name_kana、 birthdayが存在すれば登録できる" do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it "last_nameが6全角（漢字・ひらがな・カタカナ）でなければ登録できない" do
        @user.last_name = "aaa"
        @user.valid?
